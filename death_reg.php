...
<head>
    ...
    <title>Death Registration Page:: BADRS</title>
...
<div class="container" style="margin-top: 25px; color: white;">
    ...
    <div class="row" style="padding: 5px; gap: 7px;">
        ...
        <select name="cause_of_death" id="" class="form-control col-sm">
            <option value="Select">Select Cause of Death</option>
            <option value="Natural Death">Natural Death</option>    
            <option value="Sickness/Illness">Sickness/Illness</option>
            <option value="Accident">Accident</option>
        </select>
                <!-- <input type="text" placeholder="Cause of Death" class="form-control col-sm" name="cause_of_death"> -->
    ...
    <div class="row" style="padding: 5px; gap: 7px;">
        ...
        Sex:&nbsp;&nbsp; Male&nbsp;<input type="radio" value="Male" name="sex">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <input type="number" placeholder="Age" class="form-control col-sm" name="age">
    </div>
