...
<!-- <nav class="navbar navbar-lg navbar-dark bg-dark">
  ...
  <li class="nav-item">
    <a class="nav-link" href="death_reg.php" style="color:#fff; font-weight: bold;">New_Death_Record</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="birth_record.php" style="color:#fff; font-weight: bold;">Manage_Birth_Record</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="death_record.php" style="color:#fff; font-weight: bold;">Manage_Death_Record</a>
  </li>
  <li class="nav-item">
